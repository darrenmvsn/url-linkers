...
import { getSavedPosts, updateUserName, getProfileIcon, getProfileName } from 'app/lib/firebase';
  ...
  return (
    ...
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="flex flex-row items-center justify-center">
        ...
        {editState === 'Display' ? (
          <Button auto flat onClick={editProfile} className="cursor-pointer">
            <EditOutlinedIcon />
          </Button>
        ) : (
          <div className="flex flex-row items-center justify-center">
            <Input value={name} onChange={(e) => setName(e.target.value)} size="sm" className='mr-2' />
